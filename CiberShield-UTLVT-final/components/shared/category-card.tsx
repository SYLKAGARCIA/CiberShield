...
export function CategoryCard({ categoria }: { categoria: Categoria }) {
  ...
  return (
    ...
    >
      {/* Barra de acento lateral, se ilumina en verde al pasar el cursor */}
      <span
        aria-hidden="true"
      ...
      {/* Ícono en insignia circular que "flota" sobre el borde superior */}
